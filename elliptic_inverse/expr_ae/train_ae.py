...
sumry_header=('Time','half_depth/node_sizes','latent_dim','activation','noise_std','dif (min,med,max)')
sumry_np=np.array([ctime,con_str,latent_dim,act_str,noise,dif_str])
