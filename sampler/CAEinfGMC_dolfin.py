...
class CAEinfGMC:
    ...
    """
    def __init__(self,parameter_init,model,latent_geom,cae,step_size,step_num,alg_name,adpt_h=False,**kwargs):
        """
        Initialization
        """
        # parameters
